...
@JsonTypeInfo(
	...
	include = As.PROPERTY,
	property = "T")
public interface StructuringObjectPersistableMixIn<E extends iStructurable> {
	
	@JsonIgnore
	iStructuringSet<E> getStructuringSet();
	
	@JsonSetter
	void setObject(final E object);
	
	@JsonDeserialize(
		contentAs = StructuringNodePersistable.class)
	@JsonSetter
	void setStructuringNodes(final Set<iStructuringNode> structuringNodes);
