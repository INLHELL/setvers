...
@JsonSubTypes({
	@Type(
		value = aProcessNode.class),
	@Type(
		value = aProcessComposite.class),
})
public interface aProcessComponentMixIn {
	
	@JsonIgnore
	iProcessComposite getParentProcess();
	
	@JsonIgnore
	iProcessComponent getRoot();
