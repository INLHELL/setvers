...
public class StringUtils {
	...
	public static InputStream makeInputStreamFromString(final String string) {
	...
	public static String makeStringFromInputStream(final InputStream stream) {
