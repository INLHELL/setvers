 ...
 * /reflectutils/map/OrderedMap.java $
 ...
 * Use {@link ArrayOrderedMap} or {@link ConcurrentOrderedMap} depending on your
 * needs<br/>
 * 
...
public interface OrderedMap<K, V> extends Map<K, V> {
	...
	/**
	 * @param name (optional) the name to use when encoding this map of data, may
	 *          be null
	 */
	public String getName();
	
	/**
	 * @return a list of all the values in this map in the order they were
	 *         entered,
	 *         this list is a copy and manipulating it has no effect on the map
	 */
