 ...
 * /reflectutils/transcoders/TranscoderUtils.java $
...
public class TranscoderUtils {
	...
	/**
	 * This will ensure that no objects that are known to be impossible to
	 * serialize properly will
	 * cause problems with the transcoders by allowing them to go into loops
	 * 
	 * @param object
	 * @return a null if the current object is not special, an empty string to
	 *         indicate the
	 *         object should be skipped over with no output, and any string value
	 *         to indicate the
	 *         return value to use instead of attempting to encode the object
	 */
	public static String checkObjectSpecial(final Object object) {
		String special = null;
		if (object != null) {
	 ...
	 * this allows there to be added control over the way certain types of objects
	 * are encoded
	 * 
	 * @param object
	 * @return a null if the current object is not special, an empty string to
	 ...
	 *         return value to use instead of attempting to encode the object
	 */
	public static String handleObjectEncoding(final Object object, final List<ObjectEncoder> encoders) {
		String encoded = null;
		if (encoders != null) {
			for (final ObjectEncoder encoder : encoders) {
				try {
