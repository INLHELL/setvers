...
/**
 * Special handler which allows an extra encoder to be placed into the
 * transcoder pipeline which
 * will be called when objects are being encoded using whichever transcoder this
 * is handed to,
