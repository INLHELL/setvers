 ...
 * /reflectutils/annotations/ReflectIncludeStaticFields.java $
 * ReflectIgnoreClassFields.java - genericdao - Sep 21, 2008 12:45:51 PM -
 * azeckoski
 ************************************************************************** 
...
/**
 * Indicate that all static fields on a class should be included when performing
 * class
 ...
 * Normally only the name field would be including when performing field
 * reflection operations.
 * If this annotation is added to the class then both fields would be included
 * in the
 * list of fields for a class. Also, any static fields on any extended classes
 * or interfaces
