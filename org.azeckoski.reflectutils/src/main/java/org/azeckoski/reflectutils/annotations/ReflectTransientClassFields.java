 ...
 * /reflectutils/annotations/ReflectTransientClassFields.java $
 * ReflectTransientClassFields.java - genericdao - Sep 21, 2008 12:45:51 PM -
 * azeckoski
 ************************************************************************** 
 ...
 * Adding the annotation like so to the class will cause the phone field to
 * marked as transient for field operations:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * And this annotation would cause the email and phone fields to be marked as
 * transient:
 * 
 * <pre>
