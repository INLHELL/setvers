 ...
 * /reflectutils/annotations/ReflectIgnoreClassFields.java $
...
/**
 * Indicate fields on a class which should be ignored when performing class
 * field operations <br/>
 * This is primarily for indicating that reflection operations should not affect
 * fields in classes
 * which you are extending or constant fields in interfaces <br/>
 * For example: <br/>
 * Given a class with 3 String fields: name, email, phone <br/>
 * Adding the annotation like so to the class will cause the phone field to not
 * be counted for field reflection operations:
 * 
 * <pre>
