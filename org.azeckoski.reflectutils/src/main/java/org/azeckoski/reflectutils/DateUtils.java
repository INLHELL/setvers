...
public class DateUtils {
	...
	public static String makeDateISO8601(final Date date) {
	...
	public static String makeDateRFC2822(final Date date) {
		final SimpleDateFormat df = new SimpleDateFormat("EEE', 'dd' 'MMM' 'yyyy' 'HH:mm:ss' 'Z", Locale.US);
