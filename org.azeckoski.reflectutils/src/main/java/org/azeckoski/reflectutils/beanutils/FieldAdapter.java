 ...
 * /reflectutils/beanutils/FieldAdapter.java $
...
/**
 * Interface that allows us to adapt to special class types like the apache
 * dynabeans without
...
public interface FieldAdapter {
	 ...
	 * mostly for internal usage, use getFieldValue <br/>
	...
	/**
	 * @param obj any object
	 * @return true if this object is part of the set this adapter is made to
