 ...
 * /reflectutils/converters/FileConverter.java $
...
public class FileConverter implements Converter<File> {
	...
	public File convert(final Object value) {
		...
		if (f == null) {
			throw new UnsupportedOperationException("File convert failure: cannot convert source (" + value + ") and type ("
																							+ value.getClass() + ") to a File");
		}
		return f;
	}
