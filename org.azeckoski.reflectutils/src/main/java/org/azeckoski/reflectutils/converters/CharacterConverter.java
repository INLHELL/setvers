 ...
 * /reflectutils/converters/CharacterConverter.java $
...
/**
 * Converts objects to a character (will mostly truncate the string value of the
 * object)
 * 
...
public class CharacterConverter implements Converter<Character> {
	...
	public Character convert(final Object value) {
		...
		if (c == null) {
			throw new UnsupportedOperationException("Character convert failure: cannot convert source (" + value
																							+ ") and type (" + value.getClass() + ") to a char");
		}
		return c;
	}
