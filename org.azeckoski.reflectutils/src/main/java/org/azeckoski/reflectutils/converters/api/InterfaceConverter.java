 ...
 * /reflectutils/converters/api/InterfaceConverter.java $
...
/**
 * Special converter which is used for converting to an interface when more
 * control
 * over the type of implementation to create under the interface is desired<br/>
 * 
 * @see Converter for more details about the core converter interface and
